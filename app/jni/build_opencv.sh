...
export YOUR_OPENCV_BUILD_FOLDER=../jniLibs/OpenCV
export ANDROID_SDK=/opt/Android
export NDK_ROOT=/opt/Android/ndk/25.2.9519653

PATH="/usr/lib/jvm/java-17-openjdk-amd64/bin:$PATH" JAVA_HOME="/usr/lib/jvm/java-17-openjdk-amd64" python3 $YOUR_OPENCV_SRC_FOLDER/platforms/android/build_sdk.py $YOUR_OPENCV_BUILD_FOLDER $YOUR_OPENCV_SRC_FOLDER --ndk_path $NDK_ROOT --sdk_path $ANDROID_SDK --config ./opencv-ndk.config.py --no_samples_build
