...
Java_com_lukesimmons_galleryvision_OCRPredictorNative_init(
...
Java_com_lukesimmons_galleryvision_OCRPredictorNative_forward(
...
Java_com_lukesimmons_galleryvision_OCRPredictorNative_release(
