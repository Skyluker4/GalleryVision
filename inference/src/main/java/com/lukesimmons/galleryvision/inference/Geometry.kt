...
object Geometry {
    ...
    fun convexHull(points: FloatArray): FloatArray {
        ...
        while (i + 1 < points.size) {
            pts.add(points[i] to points[i + 1])
            i += 2
        }
        ...
        fun cross(
            ...
            a: Pair<Float, Float>,
            b: Pair<Float, Float>,
        ): Float = (a.first - o.first) * (b.second - o.second) - (a.second - o.second) * (b.first - o.first)
    ...
    fun minAreaRect(hull: FloatArray): FloatArray {
        ...
        if (n < 3) {
            ...
            for (k in 0 until min(4, n)) {
                out[k * 2] = hull[k * 2]
                out[k * 2 + 1] = hull[k * 2 + 1]
            }
            return out
        }
